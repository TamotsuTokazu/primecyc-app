...
namespace p {
    ...
    const Integer Q = lbcrypto::FirstPrime<Integer>(56, p0 * p1);
    ...
    const Integer bigModulus = lbcrypto::FirstPrime<Integer>(1 + (int)(std::ceil(std::log2(2 * p0 - 1) + 2 * std::log2(Q.ConvertToInt()))), nttSize);
